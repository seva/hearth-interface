...
export interface HearthGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface HearthGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): HearthGovernor;
  waitForDeployment(): Promise<this>;

  interface: HearthGovernorInterface;
