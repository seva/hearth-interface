...
export interface HearthTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface HearthToken extends BaseContract {
  connect(runner?: ContractRunner | null): HearthToken;
  waitForDeployment(): Promise<this>;

  interface: HearthTokenInterface;
