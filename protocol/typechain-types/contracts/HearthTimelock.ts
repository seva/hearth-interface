...
export interface HearthTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface HearthTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): HearthTimelock;
  waitForDeployment(): Promise<this>;

  interface: HearthTimelockInterface;
